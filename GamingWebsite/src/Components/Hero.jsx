        ...
        <div id="video-frame" className="relative z-10 h-dvh w-screen overflow-hidden rounded-lg bg-blue-75" >
            <div>
                ...
                <video ref={nextVideoRef} src={getVideoSrc(currentIndex)
                    } loop muted id="next-video" className="absolute-center invisible z-20 size-64 object-cover object-center"
                    ...
                    ></video>
                        ...
                        <div className="mt-24 px-5 sm:px-10">
                            <h1 className="special-font hero-heading block text-blue-100">redefi<b>n</b>e</h1>
                            <p className="mb-5 max-w-64 font-robert-regular text-blue-100">Enter the MetaGame Layer<br/> Unleash Economy</p>   
